#!/usr/bin/env bash
# Base16 Base2Tone-Morning - Gnome Terminal color scheme install script
...
gset string palette "#232834:#1659df:#b29762:#e5ddcd:#3d75e6:#b29762:#728fcb:#8d95a5:#656e81:#1659df:#b29762:#e5ddcd:#3d75e6:#b29762:#728fcb:#dee6f7"
gset string background_color "#232834"
gset string foreground_color "#8d95a5"
gset string bold_color "#8d95a5"
