#!/usr/bin/env bash
# Base16 Base2Tone-Drawbridge - Gnome Terminal color scheme install script
...
gset string palette "#1b1f32:#627af4:#67c9e4:#99e9ff:#7289fd:#67c9e4:#8b9efd:#9094a7:#51587b:#627af4:#67c9e4:#99e9ff:#7289fd:#67c9e4:#8b9efd:#e1e6ff"
gset string background_color "#1b1f32"
gset string foreground_color "#9094a7"
gset string bold_color "#9094a7"
